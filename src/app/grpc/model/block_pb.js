...
proto.model.Block.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    blocksmithaddress: jspb.Message.getFieldWithDefault(msg, 9, ""),
...
proto.model.Block.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 9:
      var value = /** @type {string} */ (reader.readString());
      msg.setBlocksmithaddress(value);
      break;
    case 10:
      var value = /** @type {string} */ (reader.readInt64String());
...
proto.model.Block.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getBlocksmithaddress();
  if (f.length > 0) {
    writer.writeString(
      9,
      f
...
/**
 * optional string BlocksmithAddress = 9;
 * @return {string}
 */
proto.model.Block.prototype.getBlocksmithaddress = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 9, ""));
};


/** @param {string} value */
proto.model.Block.prototype.setBlocksmithaddress = function(value) {
