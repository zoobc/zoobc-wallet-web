...
proto.model.Receipt.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    receiptmerkleroot: msg.getReceiptmerkleroot_asB64(),
...
proto.model.Receipt.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 7:
      var value = /** @type {!Uint8Array} */ (reader.readBytes());
      msg.setReceiptmerkleroot(value);
      break;
    case 8:
      var value = /** @type {!Uint8Array} */ (reader.readBytes());
...
proto.model.Receipt.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getReceiptmerkleroot_asU8();
  if (f.length > 0) {
    writer.writeBytes(
      7,
      f
...
/**
 * optional bytes ReceiptMerkleRoot = 7;
 * @return {!(string|Uint8Array)}
 */
proto.model.Receipt.prototype.getReceiptmerkleroot = function() {
...
/**
 * optional bytes ReceiptMerkleRoot = 7;
 * This is a type-conversion wrapper around `getReceiptmerkleroot()`
 * @return {string}
 */
proto.model.Receipt.prototype.getReceiptmerkleroot_asB64 = function() {
  return /** @type {string} */ (jspb.Message.bytesAsB64(
      this.getReceiptmerkleroot()));
};
 ...
 * @return {!Uint8Array}
 */
proto.model.Receipt.prototype.getReceiptmerkleroot_asU8 = function() {
  return /** @type {!Uint8Array} */ (jspb.Message.bytesAsU8(
      this.getReceiptmerkleroot()));
};
...
/** @param {!(string|Uint8Array)} value */
proto.model.Receipt.prototype.setReceiptmerkleroot = function(value) {
