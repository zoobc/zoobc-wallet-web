 ...
 * @const
 */
proto.model.Transaction.oneofGroups_ = [[14,15,16,17,18,19,20,21]];
...
/**
 * optional RemoveAccountDatasetTransactionBody removeAccountDatasetTransactionBody = 21;
...
proto.model.Transaction.prototype.getRemoveaccountdatasettransactionbody = function() {
  return /** @type{?proto.model.RemoveAccountDatasetTransactionBody} */ (
    jspb.Message.getWrapperField(this, proto.model.RemoveAccountDatasetTransactionBody, 21));
};
...
proto.model.Transaction.prototype.setSignature = function(value) {
  jspb.Message.setProto3BytesField(this, 22, value);
};
