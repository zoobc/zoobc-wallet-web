...
export class SendmoneyComponent implements OnInit {
  ...
  onSendMoney() {
    if (this.formSend.valid) {
      ...
      const seed = GetSeedFromPhrase(this.passphrase);

      this.pairKey = GetKeyPairFromSeed(seed);
      // console.log("pair",this.pairKey)
      this.pubKey = GetPublicKeyFromSeed(seed);
      // console.log("pubkey",this.pubKey)
      this.address = GetAddressFromPublicKey(this.pubKey);
      ...
      } else if (!(this.address == this.appServ.currAddress)) {
